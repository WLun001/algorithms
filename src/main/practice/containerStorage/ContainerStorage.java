...
/**
 * Container storage regions are usually set up in a port where a crane is assigned to each region.
 * Each region is a rectangular area with stacks of containers.
 * It is assumed that there are at most 10 containers in one stack due to the height of a crane. In addition, each container is given a unique identity number and a description of the content.
 */
